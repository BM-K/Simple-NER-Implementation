...
class Arguments():
    ...
    def add_hyper_parameters(self):
        self.add_argument('--patient', type=int, default=30)
    ...
    def add_data_parameters(self):
        self.add_argument('--train_data', type=str, default='ner_bin_train.hdf5')
        self.add_argument('--valid_data', type=str, default='ner_bin_valid.hdf5')
        self.add_argument('--test_data', type=str, default='ner_bin_test.hdf5')
        self.add_argument('--label_dict', type=str, default='label_dict.json')
